...
class CategoryMapperTest {
    ...
    @Test
    fun `categoryLabel - 표시용 라벨 추출`() {
        Assertions.assertThat(categoryLabel("음식점 > 치킨")).isEqualTo("치킨")
        Assertions.assertThat(categoryLabel("음식점 > 한식 > 육류,고기")).isEqualTo("한식")
        Assertions.assertThat(categoryLabel("카페 > 커피전문점")).isEqualTo("카페")
        Assertions.assertThat(categoryLabel("음식점 > 술집 > 호프,요리주점")).isEqualTo("술집")
        Assertions.assertThat(categoryLabel(null)).isEqualTo("기타")
        Assertions.assertThat(categoryLabel("")).isEqualTo("기타")
    }
}