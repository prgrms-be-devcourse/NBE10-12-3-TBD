      ...
      <div className="search-map-viewport relative overflow-hidden rounded-2xl border border-hairline-soft lg:h-[calc(100vh-6.5rem)] lg:min-h-0">
        ...
        {showResearchButton && (
          <button
            ...
            disabled={loading}
            className="absolute left-1/2 top-[7rem] z-30 -translate-x-1/2 rounded-full border border-hairline-soft bg-white px-5 py-2.5 text-sm font-bold text-ink shadow-lg transition-all hover:border-primary/30 hover:text-primary disabled:cursor-not-allowed disabled:opacity-60 lg:left-[calc(50%+200px)] lg:top-5"
          >
